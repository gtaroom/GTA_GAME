...
function PopupContent({ notification }: { notification: Notification }) {
    ...
    if (notification.type === 'game_account_approved') {
        console.log('📋 Game account data:', {
            gameName: (notification as any).gameName,
            username: (notification as any).generatedUsername,
            password: (notification as any).generatedPassword,
                ...
                <div className='space-y-6'>
                    ...
                    >
                        ...
                        <ol className='text-xs text-foreground/80 space-y-1 list-decimal list-inside'>
                            ...
                            <li>
                                Click Add Game GC, provide your username, and
                                play!
                            </li>
                        </ol>
                    </NeonBox>
                    ...
                    >
                        <p className='text-xs text-yellow-500'>
                            <span className='font-semibold'>Note:</span> New
                            users will be sent a username and temporary
                            password.
                        </p>
                    </NeonBox>
