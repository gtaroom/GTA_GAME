                        ...
                        <div className='flex-1'>
                            ...
                            <div className='bg-red-900/30 border border-red-500/30 rounded-lg p-4 mb-4'>
                                ...
                                <div className='flex items-center justify-between'>
                                    ...
                                    <span className='text-sm font-bold text-yellow-400'>
                                        {(
                                            MIN_BALANCE_REQUIRED - userBalance
                                        ).toLocaleString()}{' '}
                                        GC
                                    </span>
                                </div>
                            ...
                            <div className='flex flex-col gap-3'>
                                ...
                                <p className='text-xs text-red-300 text-center'>
                                    Click to instantly add coins and continue
                                    with your game account creation
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className='flex items-start gap-4'>
                            ...
                            <div className='flex-1'>
                                ...
                                <div className='space-y-2'>
                                    ...
                                    />
                                    {rechargeAmount &&
                                        !isNaN(parseFloat(rechargeAmount)) &&
                                ...
                                <div className='mt-3 p-3 bg-purple-900/30 rounded-lg'>
                                    <div className='flex items-start gap-2 text-xs text-purple-300'>
                                        ...
                                        <div>
                                            ...
                                            Adding your amount to load into the
                                            game now saves time! Our team will
                                            handle both your account creation
                                            and Gold Coin load together. You can
                                            also skip this step and add it
                                            later.
                                        </div>
                                    </div>
                                </div>
