...
export default function SweepstakesSpinModal() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                setSuccessMessage(
                    'Successfully claimed your free sweepstakes spin! 🎉'
                );
                ...
                throw new Error(
                    response.message || 'Failed to claim sweepstakes spin'
                );
            }
        } catch (error: any) {
            ...
            let errorMessage =
                'Failed to claim sweepstakes spin. Please try again.';
                ...
                <div className='px-5 py-3 flex flex-col items-center text-center'>
                    ...
                    {successMessage && (
                        <div className='mb-6 p-6 bg-green-500/20 border-2 border-green-500/50 rounded-lg w-full animate-in fade-in zoom-in duration-300'>
                            <NeonText
                                className='text-green-400 text-base lg:text-lg font-bold text-center'
                    ...
                    <form onSubmit={handleSubmit} className='mb-2.5 w-full'>
                        ...
                        <div className='flex flex-col gap-4 mb-6 text-left'>
                            ...
                            <div className='site-checkbox flex items-start gap-3'>
                                ...
                                >
                                    ...
                                    . I confirm I am 21+ and in an eligible
                                    location.
                                </NeonText>
                            </div>
                            {errors.agreed && (
                            ...
                            <div className='site-checkbox flex items-start gap-3'>
                                ...
                                >
                                    ...
                                    purchase does not increase chances of
                                    winning. Free entry (AMOE) is available as
                            ...
                            <div className='flex flex-col gap-2'>
                                <div className='site-checkbox flex items-start gap-3'>
                                    ...
                                    >
                                        ...
                                        or text. I can opt out anytime.
                                    </NeonText>
                                </div>

                                {/* Small print directly under optional checkbox */}
                                <NeonText className='text-xs text-white/70 leading-relaxed ml-9'>
                                    By opting in, I agree to receive marketing
                                    messages. Consent is not required to play.
                                    Reply STOP to opt out, HELP for help. Msg
                        ...
                        <Button
                            ...
                            className='mb-8'
                            disabled={
                                isSubmitting || !user?._id || !!successMessage
                            }
                        >
                            {!user?._id
                                ? 'Login to Claim'
